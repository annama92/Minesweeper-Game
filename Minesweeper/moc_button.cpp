...
QT_MOC_LITERAL(1, 7, 11), // "leftClicked"
QT_MOC_LITERAL(2, 19, 0), // ""
QT_MOC_LITERAL(3, 20, 3), // "row"
QT_MOC_LITERAL(4, 24, 3), // "col"
QT_MOC_LITERAL(5, 28, 12), // "rightClicked"
QT_MOC_LITERAL(6, 41, 15), // "handleLeftClick"
QT_MOC_LITERAL(7, 57, 16) // "handleRightClick"

    },
    "Button\0leftClicked\0\0row\0col\0rightClicked\0"
    "handleLeftClick\0handleRightClick"
};
...
void Button::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (Button::*)(int , int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Button::leftClicked)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Button::*)(int , int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Button::rightClicked)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void Button::leftClicked(int _t1, int _t2)
{
...
// SIGNAL 1
void Button::rightClicked(int _t1, int _t2)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))), const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t2))) };
